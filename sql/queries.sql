USE company_datadabe
/*1-How much revenue does the company we make per month?*/
SELECT YEAR(o.date) AS year, MONTH(o.date) AS month
    SUM(od.product_quantity * p.product_price) AS total_month_revenue
FROM orders o
